...
desktop-keywords = klikka;камера;kamera;camera;вебкамера;знімок;фото;видиво;відео;запис;космік;photo;video;
...
filter-noir = Нуар
filter-mono = Моно
filter-vivid = Насичений
filter-pencil = Нарис
overlay-effect-frosted = Матове скло
overlay-effect-translucent = Прозорий
