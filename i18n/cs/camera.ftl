...
ptz-pan = Otočení
ptz-tilt = Náklon
desktop-keywords = klikka;kamera;fotoaparát;webkamera;fotografie;video;
...
metainfo-description-intro = { app-name } je moderní aplikace kamery pro Linux, navržená pro stolní počítače i mobilní zařízení. Ať už potřebujete rychle vyfotit snímek, natočit video nebo naskenovat QR kód, { app-name } nabízí čisté a intuitivní rozhraní, které vás při používání neruší.
