...
desktop-keywords = klikka;kamera;webkamera;foto;video;
metainfo-summary = Ta foton och videor
metainfo-description-intro = { app-name } är ett modernt kamera program för Linux, byggt för både stationära datorer och telefoner. Oavsett om du behöver ta ett snabbt foto, spela in en video eller skanna en QR-kod, så ger{ app-name } dig ett rent och intuitivt gränssnitt som håller sig ur vägen.
