<!-- Generated by scripts/gen-metadata.py. Edit the captions in i18n/bg/camera.ftl and run `just generate`. -->
...
> 6 of 6 captions are not translated into `bg` yet
> and are shown in English. Translations are welcome in
> [`i18n/bg/camera.ftl`](../../../i18n/bg/camera.ftl).
