<!-- Generated by scripts/gen-metadata.py. Edit the captions in i18n/kmr/klikka.ftl and run `just generate`. -->
...
> 6 of 6 captions are not translated into `kmr` yet
> and are shown in English. Translations are welcome in
> [`i18n/kmr/klikka.ftl`](../../../i18n/kmr/klikka.ftl).
